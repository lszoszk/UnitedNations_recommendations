...
function renderMethodology() {
  ...
  root.innerHTML = `
    <div class="me">
      ...
      <p>This dashboard aggregates <strong>272,502 observations and recommendations</strong> issued by UN human-rights mechanisms — Treaty Bodies, Special Procedures and the Universal Periodic Review — in their review of States, covering the twenty-year period 2006 – 2026. The raw OHCHR export carries 272,513 records; Stage 5 of our pipeline drops 11 of them as content-free artefacts (see below). Across the remaining 272,502, Stages 1–4 made at least one non-whitespace edit to <strong>~56,000 records (≈21 % of the dataset)</strong>; the rest passed through unchanged.</p>
      ...
      <section class="me-sec" id="me-cleanup">
        ...
        <ul>
          ...
          <li><strong>Stage 5 — artefact drop.</strong> <strong>11 rows</strong> from the raw export (272,513 → 272,502) are removed because they carry no citable content after Stages 1–4. Three categories:
