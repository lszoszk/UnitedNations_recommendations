...
function renderMethodology() {
  ...
  root.innerHTML = `
    <div class="me">
      ...
      <p>This dashboard aggregates <strong>267,942 observations and recommendations</strong> issued by UN human-rights mechanisms — Treaty Bodies, Special Procedures and the Universal Periodic Review — in their review of States, covering the twenty-year period 2006 – 2026. The raw OHCHR export carries 267,953 records; Stage 5 of our pipeline drops 11 of them as content-free artefacts (see below). Across the remaining 267,942, Stages 1–4 made at least one non-whitespace edit to <strong>~56,000 records (≈21 % of the dataset)</strong>; the rest passed through unchanged.</p>
      ...
      <section class="me-sec" id="me-cleanup">
        ...
        <ul>
          ...
          <li><strong>Stage 4 — country backfill from UN document symbol.</strong> <strong>106 records</strong> (0.04 %) arrived with no country metadata despite a country code being literally present in their symbol (<code>CEDAW/C/<strong>ALB</strong>/CO/4</code>, <code>CRPD/C/<strong>AZE</strong>/CO/1</code>). A single regex + data-derived ISO-alpha-3 lookup rescues <strong>all 106</strong> (mostly Azerbaijan CRPD-2014 + Albania CEDAW-2016 batches); a handful of thematic SR reports remain legitimately country-agnostic. Appends-only, tagged <code>source: inferred:symbol</code> in <code>record_country</code>.</li>
          <li><strong>Stage 5 — artefact drop.</strong> <strong>11 rows</strong> from the raw export (267,953 → 267,942) are removed because they carry no citable content after Stages 1–4. Three categories:
      ...
      <section class="me-sec" id="me-coverage">
        ...
        <p>The hex map shows <strong>198 state parties</strong> plus a <strong>European Union</strong> tile. The 198 are UN M49 member states + observer states that appear in UHRI records; every one has at least one Treaty Body / UPR / Special Procedure recommendation or observation attached. <strong>Kosovo*</strong> is included as an <strong>XKX</strong> hex in southern Europe — it sits outside UN M49 because of its contested status, but the UHRI export carries 75 records against it and routing those into a visible hex makes the coverage audit-friendly; the OHCHR asterisk is retained in the source data to flag observer status. <strong>Cook Islands</strong> (COK) and <strong>Niue</strong> (NIU) are self-governing territories in free association with New Zealand — neither holds UN Member State status, but both participate in OHCHR mechanisms and carry UHRI records, so they are counted in the 198. <strong>State of Palestine</strong>* (PSE) and the <strong>Holy See</strong> (VAT) are UN General Assembly observer states whose OHCHR records are likewise included; the asterisk follows OHCHR usage to flag non-full-member status. The <strong>European Union</strong> hex (dashed border, top of the Europe cluster) exists because the UHRI export carries 233 records against it as a regional bloc — Special Procedures country visits, joint communications, thematic dialogues. The bloc is <strong>not</strong> counted toward the 198 sovereign-states total. <strong>Bermuda</strong> was dropped from the layout in the 2026-04-22 revision — it's a UK Overseas Territory, not a UN Member State, so OHCHR doesn't issue recommendations on it. <strong>Taiwan</strong> is absent: it is not a UN Member State and is not reviewed as a State by the Treaty Bodies, Special Procedures or the UPR, so it carries no UHRI records of its own. <strong>Western Sahara</strong> is a UN-listed Non-Self-Governing Territory rather than a State, so it has no separate review track — its human-rights situation is taken up within <strong>Morocco</strong>'s UPR and Treaty Body cycles (and the Secretary-General's annual Western Sahara report), and any such records sit under Morocco (MAR) here, not under a standalone tile.</p>
