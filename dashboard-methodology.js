...
function renderMethodology() {
  ...
  root.innerHTML = `
    <div class="me">
      ...
      <p>This dashboard aggregates <strong>267,671 observations and recommendations</strong> addressed to UN Member States by Treaty Bodies, Special Procedures and the Universal Periodic Review, covering the twenty-year period 2006 – 2026. The raw OHCHR export carries 267,682 records; Stage 5 of our pipeline drops 11 of them as content-free artefacts (see below). Across the remaining 267,671, Stages 1–4 made at least one non-whitespace edit to <strong>~56,000 records (≈21 % of the dataset)</strong>; the rest passed through unchanged.</p>
