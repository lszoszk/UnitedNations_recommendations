...
async function renderGroup() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="gpTime" title="Export chart as SVG">⬇ SVG</button><span id="gpStackToggle"></span><span id="gpLegend"></span></div></div><div class="tl-wrap" id="gpTime"><div class="panel-loading">loading</div></div></div>
...
async function renderSDG() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="spTime" title="Export chart as SVG">⬇ SVG</button><span id="spStackToggle"></span><span id="spLegend"></span></div></div><div class="tl-wrap" id="spTime"><div class="panel-loading">loading</div></div></div>
...
async function renderMechanism() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="mpTime" title="Export chart as SVG">⬇ SVG</button><span id="mpLegend"></span></div></div><div class="tl-wrap" id="mpTime"><div class="panel-loading">loading</div></div></div>
