...
async function renderCountry() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / -1"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume by year</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="cpTime" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="cpTime" title="Export chart as PNG">⬇ PNG</button><span id="cpStackToggle"></span><span id="cpLegend"></span></div></div><div class="tl-wrap" id="cpTime"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.B</span><span class="t">Themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="cpThemes" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cpThemes"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.C</span><span class="t">Recommending bodies</span></div><div class="panel-actions"><button class="chart-export small" data-export="cpBodies" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cpBodies"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.D</span><span class="t">Concerned groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="cpGroups" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cpGroups"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.E</span><span class="t">Top SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="cpSdgs" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cpSdgs"><div class="panel-loading">loading</div></div></div>
...
async function renderTheme() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="thTime" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="thTime" title="Export chart as PNG">⬇ PNG</button><span id="thStackToggle"></span><span id="thLegend"></span></div></div><div class="tl-wrap" id="thTime"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.B</span><span class="t">Top countries</span></div><div class="panel-actions"><button class="chart-export small" data-export="thCountries" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="thCountries"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.C</span><span class="t">Co-occurring themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="thThemes" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="thThemes"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.D</span><span class="t">Concerned groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="thGroups" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="thGroups"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.E</span><span class="t">Top SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="thSdgs" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="thSdgs"><div class="panel-loading">loading</div></div></div>
...
async function renderGroup() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="gpTime" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="gpTime" title="Export chart as PNG">⬇ PNG</button><span id="gpStackToggle"></span><span id="gpLegend"></span></div></div><div class="tl-wrap" id="gpTime"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.B</span><span class="t">Top countries</span></div><div class="panel-actions"><button class="chart-export small" data-export="gpCountries" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="gpCountries"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.C</span><span class="t">Top themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="gpThemes" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="gpThemes"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.D</span><span class="t">Co-occurring groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="gpGroups" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="gpGroups"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.E</span><span class="t">Top SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="gpSdgs" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="gpSdgs"><div class="panel-loading">loading</div></div></div>
...
async function renderSDG() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="spTime" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="spTime" title="Export chart as PNG">⬇ PNG</button><span id="spStackToggle"></span><span id="spLegend"></span></div></div><div class="tl-wrap" id="spTime"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.B</span><span class="t">Top countries</span></div><div class="panel-actions"><button class="chart-export small" data-export="spCountries" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="spCountries"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.C</span><span class="t">Top themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="spThemes" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="spThemes"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.D</span><span class="t">Concerned groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="spGroups" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="spGroups"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.E</span><span class="t">Co-occurring SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="spSdgs" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="spSdgs"><div class="panel-loading">loading</div></div></div>
...
async function renderMechanism() {
  ...
  root.innerHTML = `
    ...
    <div class="cp-body">
      <div class="panel" style="grid-column:1 / span 2"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.A</span><span class="t">Volume over time</span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="mpTime" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="mpTime" title="Export chart as PNG">⬇ PNG</button><span id="mpLegend"></span></div></div><div class="tl-wrap" id="mpTime"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.B</span><span class="t">Top countries</span></div><div class="panel-actions"><button class="chart-export small" data-export="mpCountries" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="mpCountries"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.C</span><span class="t">Top themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="mpThemes" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="mpThemes"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.D</span><span class="t">Concerned groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="mpGroups" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="mpGroups"><div class="panel-loading">loading</div></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">FIG.E</span><span class="t">Top SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="mpSdgs" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="mpSdgs"><div class="panel-loading">loading</div></div></div>
...
async function renderCompare() {
  ...
  root.innerHTML = `
    ...
    <div class="cmp-body">
      ...
      <div class="panel" style="grid-column:1 / -1"><div class="panel-head"><div class="panel-title"><span class="idx">A</span><span class="t">Over time — <span id="cmpTimeALbl">—</span></span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="cmpTimeA" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="cmpTimeA" title="Export chart as PNG">⬇ PNG</button><span id="cmpTimeALegend"></span></div></div><div class="tl-wrap" id="cmpTimeA"></div></div>
      <div class="panel" style="grid-column:1 / -1;background:var(--paper-2)"><div class="panel-head"><div class="panel-title"><span class="idx">B</span><span class="t">Over time — <span id="cmpTimeBLbl">—</span></span></div><div class="panel-actions"><button class="chart-export small" data-export-svg="cmpTimeB" title="Export chart as SVG">⬇ SVG</button><button class="chart-export small" data-export-png="cmpTimeB" title="Export chart as PNG">⬇ PNG</button><span id="cmpTimeBLegend"></span></div></div><div class="tl-wrap" id="cmpTimeB"></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">A</span><span class="t">Themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="cmpThemesA" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cmpThemesA"></div></div>
      <div class="panel" style="background:var(--paper-2)"><div class="panel-head"><div class="panel-title"><span class="idx">B</span><span class="t">Themes</span></div><div class="panel-actions"><button class="chart-export small" data-export="cmpThemesB" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cmpThemesB"></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">A</span><span class="t">Concerned groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="cmpGroupsA" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cmpGroupsA"></div></div>
      <div class="panel" style="background:var(--paper-2)"><div class="panel-head"><div class="panel-title"><span class="idx">B</span><span class="t">Concerned groups</span></div><div class="panel-actions"><button class="chart-export small" data-export="cmpGroupsB" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cmpGroupsB"></div></div>
      <div class="panel"><div class="panel-head"><div class="panel-title"><span class="idx">A</span><span class="t">SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="cmpSdgsA" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cmpSdgsA"></div></div>
      <div class="panel" style="background:var(--paper-2)"><div class="panel-head"><div class="panel-title"><span class="idx">B</span><span class="t">SDGs</span></div><div class="panel-actions"><button class="chart-export small" data-export="cmpSdgsB" title="Copy as CSV">📋 CSV</button></div></div><div class="row-list" id="cmpSdgsB"></div></div>
    </div>`;
